...
class Cityscapes(DataBaseclass):
    ...
    def __init__(self, base_path=CITYSCAPES_BASEPATH, batchsize=1, in_memory=False,
        ...
        def get_filenames(fileset):
            if fileset == 'train_extra':
                modality_paths = {'rgb': 'leftImg8bit_trainextra/leftImg8bit',
                                  'labels': 'gtCoarse/gtCoarse',
                                  'depth': 'disparity_train/disparity'}
            else:
                modality_paths = {'rgb': 'leftImg8bit_trainvaltest/leftImg8bit',
