...
CITIES = ['aachen', 'bremen', 'darmstadt', 'erfurt', 'hanover', 'krefeld', 'strasbourg',
          'tubingen', 'weimar', 'cologne', 'dusseldorf', 'hamburg', 'jena',
          'monchengladbach', 'stuttgart', 'zurich']
    ...
    def __init__(self, base_path=CITYSCAPES_BASEPATH, batchsize=1, in_memory=False,
        ...
        if in_memory:
            ...
            measureset = [{'image': self._load_data(i['image_name'], i['image_path'])}
                          for i in get_filenames('train', cities=['ulm', 'bochum'])]
            ...
            measureset = get_filenames('train', cities=['ulm', 'bochum'])
